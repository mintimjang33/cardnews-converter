...
const LANGS = {
  ko: {
    ...
    metaDesc: '알람, 타이머, 스탑워치, 세계시각, 포모도로 타이머가 모두 담긴 무료 온라인 시계 도구. 회원가입 없이 바로 사용 가능하며 모바일에서도 완벽하게 작동합니다.',
    adLabel: '광고',
  ...
  en: {
    ...
    metaDesc: 'All-in-one free online clock featuring alarm, countdown timer, stopwatch, world time zones, and Pomodoro timer. No sign-up required, works perfectly on mobile.',
    adLabel: 'Ad',
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://www.downtools.co.kr/clock-down" />
        ...
        <link rel="canonical" href="https://www.downtools.co.kr/clock-down" />
...
/* ── WRAP (블로그/privacy/terms/faq 페이지용) ── */
      ...
      <Footer lang={lang} siteName="Clock-Down" adsOn={adsOn} slotData={findAdSlot(adSlots, 'footer')} loaded={settingsLoaded} />
